...
if __name__ == '__main__':
  ...
  argparser.add_argument("--keywords", help="Video keywords, comma separated", default="pronunciation,english,dictionary,british,american,how to say,etymology,noun,verb adjective,adverb,pronoun,preposition,conjunction,interjection,wiktionary")
